...
import 'package:testdrive/MVP/Contacts/widget/FlexibleAppBar.dart';
...
class ContactPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new Theme(
        ...
        child: new Scaffold(
          ...
          slivers: <Widget>[
            new FlexibleAppBar(_contact.fullName, _contact.imageUrl),
            new SliverPadding(
              ...
              sliver: new SliverList(
                ...
                _buildCategory(
                    Icons.today, Icons.add_alert, <String>[_contact.birthday]),
              ])),
            ),
          ],
        )));
  ...
  _ContactCategory _buildPhoneCategory() {
    final phoneItems = _contact.phones
